...
- Use `docs/README.md` for shared documentation. Keep task plans, drafts, and verification reports in ignored `tasks/`; read a local plan only when explicitly referenced.
- Store documentation images under `docs/images/` by category and update links when moving files.
